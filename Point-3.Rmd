...
```{r 3g, message=FALSE, warning=FALSE}
...
```{r 3l, message=FALSE, warning=FALSE}
...
```{r 3s, message=FALSE, warning=FALSE}
adfTest <- function(data) {
    ...
    # In conclusion we generate Table 4: the results of the Augmented Dickey-Fuller test (to check the stationarity)
...
```{r 3v, message=FALSE, warning=FALSE}

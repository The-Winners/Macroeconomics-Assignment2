...
We decide to fit the models using an ARMA(1,1)
...
After having chosen the three models we are going to use, we perform the Dickey-Fueller test
```{r 4i}
...
To sum up we can conclude that all three time series are stationary.
